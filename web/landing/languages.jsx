...
// 41 languages, Core 7 elevated as a row of detailed cards, remaining 34 as compact chips.
...
function LangGlyph({ ch, accent }) {
  return (
    <div className="lg-glyph" style={{ '--g': accent || 'var(--fg-2)' }}>
      <style>{`
        .lg-glyph {
...
function CoreCard({ lang }) {
  return (
    <article className="lg-core" style={{ '--a': lang.accent }}>
      <style>{`
        .lg-core {
          position: relative;
        ...
        .lg-core::before {
          content: ''; position: absolute; left: 0; top: 14px; height: 24px; width: 3px;
          background: var(--a); border-radius: 0 2px 2px 0;
        }
    ...
    <section className="zc-langs">
      <style>{`
        ...
        @media (max-width: 980px) {
          .zc-langs-core { grid-template-columns: repeat(4, 1fr); }
        }
        @media (max-width: 600px) {
          .zc-langs-core { grid-template-columns: repeat(2, 1fr); }
        }
        .zc-langs-divider {
        ...
        .zc-langs-divider::before, .zc-langs-divider::after {
        ...
        .zc-langs-foot {
          margin-top: 28px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;
          gap: 12px;
          font-family: var(--f-mono); font-size: 11px; color: var(--fg-3);
          letter-spacing: 0.04em;
        }
        .zc-langs-foot a {
          color: var(--fg-1); border-bottom: 1px solid var(--line-2);
          padding-bottom: 1px;
        }
      ...
      <div className="shell" id="languages">
        ...
        <div className="zc-langs-foot">
          <span>fetch the catalog: <a href="docs.html#/api">GET /v1/languages</a> · returns 41 entries</span>
          <span>need another? <a href="https://github.com/zerocode-rs/zerocode/issues/new" target="_blank" rel="noreferrer">open an issue</a></span>
        </div>
      </div>
    </section>
  );
...
Object.assign(window, { LanguageMatrix });
