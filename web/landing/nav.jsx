// landing/nav.jsx
// Tight top nav. Monospace wordmark, sparse links, version chip, theme toggle.
...
function useTheme() {
  ...
  const toggle = React.useCallback(() => {
    if (window.ZeroCodeTheme) window.ZeroCodeTheme.toggle();
    else {
  ...
  return (
    ...
    <nav className={`zc-nav ${scrolled ? 'is-scrolled' : ''}`}>
      ...
      <div className="zc-nav-inner">
        <a className="zc-mark" href="index.html">
        ...
        <div className="zc-nav-right">
          <ThemeToggle />
          <a className="zc-star" href="https://github.com/zerocode-rs/zerocode" target="_blank" rel="noreferrer">
            ...
            <span>github</span><span className="sep">·</span><span className="count">3.7k</span>
          </a>
          <a className="zc-cta-primary" href="docs.html">
            get started
